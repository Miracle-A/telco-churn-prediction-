...
# Model Performance page
    ...
    with col1:
        st.image('roc_curve_Logistic_Regression.png', caption='Logistic Regression')
    
    with col2:
        st.image('roc_curve_Random_Forest.png', caption='Random Forest')
    
    with col3:
        st.image('roc_curve_XGBoost.png', caption='XGBoost')
